...
public class LuceneUtils {
	...
	/**
	 * Find a document in the index by its docno (external ID). Returns the internal
	 * ID of the document; or -1 if not found.
	 *
	 * @param index      An index reader.
	 * @param fieldDocno The name of the field you used for storing docnos (external
	 *                   document IDs).
	...
	/**
	 * Get the DocNo (external ID) of a document stored in the index by its internal
	 * id.
	 *
	 * @param index      An index reader.
	 * @param fieldDocno The name of the field you used for storing docnos (external
	...
	public static String getDocno(IndexReader index, String fieldDocno, int docid) throws IOException {
		...
		// You should consider reuse the fieldset if you need to read docnos for a lot
		// of documents.
