...
public class LuceneBuildIndex {
	...
	public static void main(String[] args) {
		try {
			...
			String pathCorpus = "./docs/example_corpus.gz";
			...
			// Note that IndexWriterConfig.OpenMode.CREATE will override the original index
			// in the folder
			config.setOpenMode(IndexWriterConfig.OpenMode.CREATE);

			IndexWriter ixwriter = new IndexWriter(dir, config);

			// This is the field setting for metadata field (no tokenization, searchable,
			// and stored).
			...
			// This is the field setting for normal text field (tokenized, searchable, store
			// document vectors)
			...
			// Well, the following only works for small text files. DO NOT follow this part
			// for large dataset files.
